...
// Everything from contour.wgsl is available: params, tier_count(), tier(i),
// tier_color(i, h), contour_coverage(), and ShadeInput (elevation, slope, px,
// uv, elev_min, elev_max).
